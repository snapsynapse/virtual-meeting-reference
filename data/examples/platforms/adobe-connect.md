...
| Requirement | Details |
|-------------|---------|
| Persistent rooms | Reusable meeting rooms with saved layouts |
...
| Requirement | Details |
|-------------|---------|
| Room count | Up to 20 breakout rooms |
...
- [Adobe Connect Breakout Rooms](https://helpx.adobe.com/adobe-connect/using/breakout-rooms.html)
...
| Requirement | Details |
|-------------|---------|
| Server-side recording | Recordings stored on Adobe Connect server |
...
- [Adobe Connect Recording](https://helpx.adobe.com/adobe-connect/using/recording-playing-back-meetings.html)
...
| Requirement | Details |
|-------------|---------|
| Poll pods | Persistent polls embedded in room layouts |
...
- [Adobe Connect Polls](https://helpx.adobe.com/adobe-connect/using/polls.html)
...
| Requirement | Details |
|-------------|---------|
| Chat pods | Multiple chat pods with different scopes |
